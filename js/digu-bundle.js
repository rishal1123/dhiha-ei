...
(function() {
    ...
    class UIManager {
        ...
        startSinglePlayerGame() {
            this.isMultiplayerMode = false;
            const gameBoard = document.getElementById('digu-game-board') || document.getElementById('game-board');
        ...
        handleRemoteDiguDeclare(position, meldsData, isValid) {
            ...
            if (meldsData && meldsData.length > 0) {
                ...
                // Update declaring player's hand so scores calculate correctly
        ...
        showLobby() {
            ...
            const diguBoard = document.getElementById('digu-game-board');
            if (diguBoard) {
                diguBoard.classList.add('hidden');
                diguBoard.classList.remove('multiplayer-mode');
            }

            // Show Dhiha Ei board (for when switching games)
            const gameBoard = document.getElementById('game-board');
            if (gameBoard) {
        ...
        hideLobby() {
            ...
            const diguBoard = document.getElementById('digu-game-board');
            const gameBoard = document.getElementById('game-board');
            if (window.currentGame === 'digu' && diguBoard) {
                diguBoard.classList.remove('hidden');
            } else if (gameBoard) {
                gameBoard.classList.remove('hidden');
            }
